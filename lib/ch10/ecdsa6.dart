...
// ECPoint for elliptic curve points
class ECPoint {
  final BigInt x, y;
...
// Point Addition (Elliptic Curve Addition)
...
// Point Doubling (Elliptic Curve Doubling)
...
// Generate ECDSA Key Pair (Private and Public Keys)
...
// Main function to generate keys, sign, and verify the message
void main() {
  // Generate Key Pair (Private and Public Keys)
  ...
  // Hash the message (for simplicity, use a fixed message hash)
