...
bool verifySignature(
  ...
  // Calculate elliptic curve points for u1 and u2
...
void main() {
  ...
  Uint8List messageBytes = utf8.encode("123456789abcdef");
  Uint8List hash = sha256Hash(messageBytes);
  BigInt messageHash = BigInt.parse(
      hash.map((b) => b.toRadixString(16).padLeft(2, '0')).join(),
      radix: 16);

  print("Message Hash as BigInt: $messageHash");
