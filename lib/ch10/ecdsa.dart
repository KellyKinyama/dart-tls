...
//   BigInt d;
//   do {
//     d = (BigInt.from(rand.nextInt(1 << 32)) << 224) |
//         BigInt.from(rand.nextInt(1 << 224));
//   } while (d < BigInt.one || d >= CurveP256.n);
//   return d;
// }
...
BigInt generatePrivateKey() => generateSecureBigInt(CurveP256.n);
