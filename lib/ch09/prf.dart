          ...
          int out_len ) 
{
  int i;
  int half_secret_len;
  List<int> sha1_out = ( List<int>  ) malloc( out_len );
  List<int> concat = ( List<int>  ) malloc( label_len + seed_len );
...
//   out_len = atoi( argv[ 4 ] );
//   output = ( List<int>  ) malloc( out_len );
